...
class RepositoryXmlTest {
    ...
    @BeforeEach
    void setUp() {
        File customerFile = tempDir.resolve("customers.xml").toFile();
        File movieFile = tempDir.resolve("movies.xml").toFile();
        File totalsFile = tempDir.resolve("totals.xml").toFile();
